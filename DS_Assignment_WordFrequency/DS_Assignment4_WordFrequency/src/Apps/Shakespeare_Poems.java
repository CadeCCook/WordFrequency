...
public class Shakespeare_Poems {
    ...
    public static void main(String[] args) throws Exception {
        ...
        */
        ...
        Bridges bridges = new Bridges(17, "xyi2", "822915248037");
        ...
        // Build the binary-search-tree-based dictioary by reading all words and counting the occurrece of each word
        //WordBSTDictionary<String, Integer> my_dict = new WordBSTDictionary<>();

        // Read Shakespear poes
        List<Shakespeare> shksp_list = bridges.getDataSource().getShakespeareData("poems", true);//"poems", true);//"plays", "sonnets"
